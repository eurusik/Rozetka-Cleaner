...
5. У блоці **"Перевірка роботи"** можна побачити технічний стан кожної функції:
   - чи знайдені елементи за селекторами;
   - чи знайдені fallback-фрази в тексті;
   - скільки елементів фактично приховано.
   Якщо бачите статус **"Перевірити"**, це означає що на поточній сторінці Rozetka не знайдено ні селектори, ні fallback-ознаки для цієї функції.
